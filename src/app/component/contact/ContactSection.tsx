...
export default function ContactSection() {
  ...
  // shared input styles
  const inputStyles =
    'w-full bg-white dark:bg-white text-gray-900 dark:text-gray-900 placeholder-gray-500 dark:placeholder-gray-500 border border-gray-300 dark:border-gray-300 px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-[#4C07EF]'
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12">
        ...
        <motion.div
          ...
          className="backdrop-blur-sm bg-white/60 dark:bg-white/60 rounded-xl p-8 shadow-lg flex flex-col"
        >
          <span className="self-start bg-green-50 text-[#4C07EF] px-3 py-1 rounded-full text-sm font-medium">
            Contact
          </span>
          <h2 className="mt-4 text-3xl font-semibold text-gray-900 dark:text-gray-900">
            ...
            {[
              ...
              <div key={i} className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-blue-600 dark:text-blue-600">
                    {item.info}
                  </p>
                </div>
              </div>
